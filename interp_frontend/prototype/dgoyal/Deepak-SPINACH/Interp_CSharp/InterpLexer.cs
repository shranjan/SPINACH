// $ANTLR 3.1.3 Mar 18, 2009 10:09:25 Interp.g 2009-10-26 09:54:13
...
public class InterpLexer : Lexer {
    ...
    public void mTYPE() // throws RecognitionException [2]
    {
            ...
            int _type = TYPE;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Interp.g:141:6: ( ( 'int' | 'double' ) )
            // Interp.g:141:8: ( 'int' | 'double' )
            {
            	// Interp.g:141:8: ( 'int' | 'double' )
            	int alt1 = 2;
    ...
    public void mVARIABLE() // throws RecognitionException [2]
    {
            ...
            int _type = VARIABLE;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // Interp.g:142:9: ( ( 'a' .. 'z' | 'A' .. 'Z' )+ )
            // Interp.g:142:11: ( 'a' .. 'z' | 'A' .. 'Z' )+
            {
            	// Interp.g:142:11: ( 'a' .. 'z' | 'A' .. 'Z' )+
            	int cnt2 = 0;
            	do 

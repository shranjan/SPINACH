// $ANTLR 3.1.3 Mar 18, 2009 10:09:25 Interp.g 2009-10-25 20:41:00
...
public class InterpParser : Parser 
{
    ...
    // Interp.g:93:1: structdec returns [StructDeclaration ret] : ( 'Struct' el1= variable '{' ( TYPE el2= variable ';' )+ '}' ) END_OF_STATEMENT ;
    ...
    {   
        ...
        try 
    	{
            // Interp.g:97:2: ( ( 'Struct' el1= variable '{' ( TYPE el2= variable ';' )+ '}' ) END_OF_STATEMENT )
            // Interp.g:97:4: ( 'Struct' el1= variable '{' ( TYPE el2= variable ';' )+ '}' ) END_OF_STATEMENT
            {
            	root_0 = (object)adaptor.GetNilNode();

            	// Interp.g:97:4: ( 'Struct' el1= variable '{' ( TYPE el2= variable ';' )+ '}' )
            	// Interp.g:97:5: 'Struct' el1= variable '{' ( TYPE el2= variable ';' )+ '}'
            	{
            		...
            		// Interp.g:98:5: ( TYPE el2= variable ';' )+
            		int cnt7 = 0;
            		do 
            		{
            		    int alt7 = 2;
            			...
            			{
            				case 1 :
            				    // Interp.g:98:6: TYPE el2= variable ';'
            				    {
    ...
    // Interp.g:101:1: structobjdec returns [StructObjectDeclaration ret] : (el1= variable el2= variable ) END_OF_STATEMENT ;
    ...
    {   
        ...
        try 
    	{
            // Interp.g:105:2: ( (el1= variable el2= variable ) END_OF_STATEMENT )
            // Interp.g:105:4: (el1= variable el2= variable ) END_OF_STATEMENT
            {
            	root_0 = (object)adaptor.GetNilNode();

            	// Interp.g:105:4: (el1= variable el2= variable )
            	// Interp.g:105:5: el1= variable el2= variable
            	{
    ...
    // Interp.g:109:1: structassign returns [StructAssignDeclaration ret] : (el1= variable '.' el2= variable ) ;
    ...
    {   
        ...
        try 
    	{
            // Interp.g:113:2: ( (el1= variable '.' el2= variable ) )
            // Interp.g:113:3: (el1= variable '.' el2= variable )
            {
            	root_0 = (object)adaptor.GetNilNode();

            	// Interp.g:113:3: (el1= variable '.' el2= variable )
            	// Interp.g:113:4: el1= variable '.' el2= variable
            	{
    ...
    // $ANTLR start "print"
    // Interp.g:115:1: print returns [PrintOperationElement ret] : 'print' var_or_int_literal END_OF_STATEMENT ;
    ...
    {   
        ...
        try 
    	{
            // Interp.g:119:3: ( 'print' var_or_int_literal END_OF_STATEMENT )
            // Interp.g:119:5: 'print' var_or_int_literal END_OF_STATEMENT
            {
            	root_0 = (object)adaptor.GetNilNode();

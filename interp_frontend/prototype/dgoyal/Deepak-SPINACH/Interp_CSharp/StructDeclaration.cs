...
public class StructDeclaration : Element
{
    ...
    List<StructVariableDeclaration> mVar=new List<StructVariableDeclaration>();
    ...
    public List<StructVariableDeclaration> getVarType() { return mVar; }
    public void setVarType(StructVariableDeclaration var) 
    {

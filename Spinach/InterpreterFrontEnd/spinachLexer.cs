// $ANTLR 3.1.3 Mar 18, 2009 10:09:25 spinach.g 2009-11-08 18:38:18
...
public class spinachLexer : Lexer {
    ...
    public void mSTRINGTYPE() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // spinach.g:420:12: ( 'string' )
            // spinach.g:420:14: 'string'
            {
            	Match("string"); 
    ...
    public void mVARIABLE() // throws RecognitionException [2]
    {
            ...
            int _type = VARIABLE;
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // spinach.g:425:9: ( ( 'a' .. 'z' | 'A' .. 'Z' )+ )
            // spinach.g:425:11: ( 'a' .. 'z' | 'A' .. 'Z' )+
            {
            	// spinach.g:425:11: ( 'a' .. 'z' | 'A' .. 'Z' )+
            	int cnt3 = 0;
            	do 
    ...
    public void mINT_LITERAL() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // spinach.g:426:12: ( ( '0' .. '9' )+ )
            // spinach.g:426:14: ( '0' .. '9' )+
            {
            	// spinach.g:426:14: ( '0' .. '9' )+
            	int cnt4 = 0;
            	do 
    ...
    public void mDOUBLE_LITERAL() // throws RecognitionException [2]
    {
    	...
    	int _channel = DEFAULT_TOKEN_CHANNEL;
            // spinach.g:427:15: ( ( INT_LITERAL DOT INT_LITERAL ) )
            // spinach.g:427:16: ( INT_LITERAL DOT INT_LITERAL )
            {
            	// spinach.g:427:16: ( INT_LITERAL DOT INT_LITERAL )
            	// spinach.g:427:17: INT_LITERAL DOT INT_LITERAL
            	{
            		mINT_LITERAL(); 
            		mDOT(); 
            		mINT_LITERAL(); 
